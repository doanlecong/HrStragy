        ...
        <div class="card card-no-border">
            <div class="card-header card_header_gradient no-border-radius">
                <h3 class="text-left orange-text font-roboto-light"><i class="fa fa-bookmark-o" aria-hidden="true"></i>
                    Danh Sách Liên Hệ Khách Hàng</h3>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 1200px;">
            <div class="modal-content no-border-radius">
                <div class="modal-header card_header_gradient">
                    <h5 class="modal-title" id="exampleModalLongTitle">Liên Hệ Khách Hàng</h5>
                </div>
...
@section('scriptTail')
    ...
    <script>
        ...
        let filterStatus = debounce(function () {
            ...
            $.ajax({
                url:'{{ route('guest_contact.index') }}?status='+currentStatus,
                crossDomain: true,
                async: true,
                type:"GET",
                success:function (data) {
    ...
    <script>
        ...
        let findData = debounce(function () {
            ...
            if(previousName != name) {
                ...
                $.ajax({
                    url:"/authenticated/guest_contact_seach/search?name="+name,
                    crossDomain: true,
                    async: true,
                    type:"GET",
                    success:function (data) {
