    ...
    <div class="col-lg no-padding-left-right">
        <div class="card card-no-border">
            <div class="card-header card_header_gradient no-border-radius">
                <h3 class="text-left orange-text font-roboto-light"><i class="fa fa-bookmark-o" aria-hidden="true"></i> Our Service</h3>
            </div>
            <div class="card-body no-padding-left-right background-blue ">
                <div class="row mt-3 background-white padding-top-30 border-top-green">
                    <div class="col">
                        <p>
                            <a href="{{ route('our_service.create') }}" class="btn btn-primary box-shadown-darkblue"><i class="fa fa-list-ol" aria-hidden="true"></i> Create new Our Service</a>
                        </p>
                            ...
                            <table class="table table-hover table-striped " style="font-size: 0.8rem;">
                                ...
                                @foreach ($services as $s)
                                    <tr id="row{{$s->id}}">
                                        ...
                                        <td>
                                            <button class="btn btn-primary out-line-blue view-service" title="View" data-href="{{ route('our_service.viewInstant',$s->id) }}"><i class="fa fa-bolt"></i></button>
                                            <a href="{{ route('our_service.edit', $s->id) }}" class="btn btn-info pull-left" style="margin-right: 3px;">Edit</a>
                                            <button title="Delete" class="btn btn-danger pull-left" style="margin-right: 3px;" onclick="deleteService('{{ route('our_service.delete', $s->id) }}', {{ $s->id }})"><i class="fa fa-trash"></i></button>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
