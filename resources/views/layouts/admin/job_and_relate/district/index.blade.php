        ...
        <div class="card card-no-border">
            <div class="card-header card_header_gradient no-border-radius">
                <h3 class="text-left orange-text font-roboto-light"><i class="fa fa-bookmark-o" aria-hidden="true"></i>
                    Districts In <a class="animate-bottom-nocontent green-text font-playfair" href="{{ route('province.index','country='.$province->country_id) }}">{{ mb_strtoupper($province->name) }}</a> ,
                    <a class="animate-bottom-nocontent green-text font-playfair" href="{{ route('country.index') }}">{{ mb_strtoupper($province->country->name) }}</a></h3>
            </div>
            <div class="card-body no-padding-left-right background-blue no-padding-top">
                <div class="row background-white padding-top-30 border-top-green">
                    <div class="col">
                        <p>
                            <span><a href="{{ route('district.create','province='.$province->id) }}" class="btn btn-primary box-shadown-darkblue"><i
                                            class="fa fa-plus" aria-hidden="true"></i>  Add new district</a></span>
                        </p>
                                        ...
                                        <tr id="row{{$t->id}}">
                                            ...
                                            <td id="tdrow{{ $t->id }}">
                                                @if($t->status == config('global.statusActive'))
                                                    <span style="cursor: pointer;" title="Click to show or hide this in customer's page" data-id="{{ $t->id }}" data-href="{{ route('district.toggleShow', $t->id) }}" class="badge background-green white-text toogle-show box-shadown-light-dark">{{ config('global.'.$t->status) }}</span>
                                                @else
                                                    <span style="cursor: pointer;" title="Click to show or hide this in customer's page" data-id="{{ $t->id }}" data-href="{{ route('district.toggleShow', $t->id) }}" class="badge badge-danger white-text toogle-show box-shadown-light-dark">{{ config('global.'.$t->status) }}</span>
                                                @endif
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('district.edit', $t->id) }}"
                                                ...
                                                <button title="Delete" class="btn btn-danger box-shadown-light-dark mt-1"
                                                        ...
                                                        onclick="deleteService('{{ route('district.delete', $t->id) }}', {{ $t->id }})">
