        ...
        <div class="card card-no-border">
            ...
            <div class="card-body no-padding-left-right background-blue no-padding-top">
                <div class="row background-white padding-top-30 border-top-green">
                    <div class="col">
                        <p>
                            <span><a href="{{ route('job_cate.create','jobtype='.$jobtype) }}" class="btn btn-primary box-shadown-darkblue"><i
                                            class="fa fa-plus" aria-hidden="true"></i> Add New Job Category</a></span>
                        </p>
