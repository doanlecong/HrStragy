        ...
        <div class="card card-no-border">
            ...
            <div class="card-body no-padding-left-right background-blue no-padding-top">
                <div class="row background-white padding-top-30 border-top-green">
                    <div class="col">
                        <p>
                            <span><a href="{{ route('country.create') }}" class="btn btn-primary box-shadown-darkblue"><i
                                            class="fa fa-plus" aria-hidden="true"></i>  Add new country</a></span>
                        </p>
                                ...
                                @if(count($countries) > 0)
                                    @foreach($countries as $t)
                                        <tr id="row{{$t->id}}">
                                            ...
                                            <td>
                                                {{ $t->provinces()->count() }} <a title="Manage Belonged Provinces" href="{{ route('province.index','country='.$t->id) }}" class="btn btn-green white-text"><i class="fa fa-bars"></i></a>
                                            </td>
                                            <td id="tdrow{{ $t->id }}">
                                                @if($t->status == config('global.statusActive'))
                                                    <span style="cursor: pointer;" title="Click to show or hide this in customer's page" data-id="{{ $t->id }}" data-href="{{ route('country.toggleShow', $t->id) }}" class="badge background-green white-text toogle-show box-shadown-light-dark">{{ config('global.'.$t->status) }}</span>
                                                @else
                                                    <span style="cursor: pointer;" title="Click to show or hide this in customer's page" data-id="{{ $t->id }}" data-href="{{ route('country.toggleShow', $t->id) }}" class="badge badge-danger white-text toogle-show box-shadown-light-dark">{{ config('global.'.$t->status) }}</span>
                                                @endif
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('country.edit', $t->id) }}"
                                                ...
                                                <button title="Delete" class="btn btn-danger box-shadown-light-dark mt-1"
                                                        ...
                                                        onclick="deleteService('{{ route('country.delete', $t->id) }}', {{ $t->id }})">
