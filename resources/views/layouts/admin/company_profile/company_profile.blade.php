        ...
        <div class="card card-no-border">
            ...
            <div class="card-body no-padding-left-right background-blue ">
                <div class="row mt-3 background-white padding-top-30 border-top-green">
                    <div class="col">
                        <p>
                            <a href="{{ route('editCompanyProfile') }}" class="btn btn-primary box-shadown-darkblue"><i class="fa fa-list-ol" aria-hidden="true"></i> Change Information</a>
                        </p>
                        <div class="background-litle-white padding-around-20">
                            @if($info != null)
                                ...
                                <hr>
                                <h6>Nội dung hiển thị cho Trang Company Profile :</h6>
