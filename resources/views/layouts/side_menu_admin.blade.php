...
<div class="d-block">
    ...
    @if($currentUser->hasRole(config('global.admin')))
        <button class=" padding-left-5 accordion-button white-text btn text-left background-gradient-cyan-plum no-border-radius border-left-green-m btn-block box-shadown-light-dark" href="#"><i class="fa fa-tachometer"></i> Quan ly User</button>
    ...
    @if($currentUser->hasRole(config('global.cooperate_company_info')) || $currentUser->hasRole(config('global.admin')))
        <button class="  padding-left-5 accordion-button white-text text-left btn background-gradient-cyan-plum no-border-radius btn-block border-left-green-m box-shadown-light-dark mt-2" href="#"><i class="fa fa-tachometer"></i> Quan ly Contact , Company Info</button>
        <div class="accordion_content">
            ...
            <a href="{{ route('viewOurStaff') }}" class="btn btn-primary border-left-purple-thin btn-block text-left box-shadown-darkblue" ><i class="fa fa-tasks"></i> View Our Staff Info</a>
            <a href="{{ route('viewCompanyProfile') }}" class="btn btn-primary border-left-purple-thin btn-block text-left box-shadown-darkblue" ><i class="fa fa-tasks"></i> View Company Profile</a>
            <a href="{{ route('viewInternaRecruit') }}" class="btn btn-primary border-left-purple-thin btn-block text-left box-shadown-darkblue" ><i class="fa fa-tasks"></i> View Internal Recruitment</a>
        </div>

        <button class="  padding-left-5 accordion-button white-text text-left btn background-gradient-cyan-plum no-border-radius btn-block border-left-green-m box-shadown-light-dark mt-2" href="#"><i class="fa fa-tachometer"></i> Quản Lý Cooperate</button>
        <div class="accordion_content">
    ...
    @if($currentUser->hasRole(config('global.story_service')) || $currentUser->hasRole(config('global.admin')))
        <button class="  padding-left-5 accordion-button white-text text-left btn background-gradient-cyan-plum no-border-radius btn-block border-left-green-m box-shadown-light-dark mt-2" href="#"><i class="fa fa-tachometer"></i> Quan Ly Service</button>
        <div class="accordion_content">
        ...
        <button class="  padding-left-5 accordion-button white-text text-left btn background-gradient-cyan-plum no-border-radius btn-block border-left-green-m box-shadown-light-dark mt-2" href="#"><i class="fa fa-tachometer"></i> Customer Stories</button>
        <div class="accordion_content">
    ...
    @if($currentUser->hasRole(config('global.admin')) || $currentUser->hasRole(config('global.job_company_location')))
        <button class="  padding-left-5 accordion-button white-text text-left btn background-gradient-cyan-plum no-border-radius btn-block border-left-green-m box-shadown-light-dark mt-2" href="#"><i class="fa fa-tachometer"></i> Quản Lý Job, Company, Location</button>
        <div class="accordion_content">
    ...
    @if($currentUser->hasRole(config('global.candidate_guest')) || $currentUser->hasRole(config('global.admin')))
        <button class=" padding-left-5 accordion-button white-text text-left btn background-gradient-cyan-plum no-border-radius btn-block border-left-green-m box-shadown-light-dark mt-2" href="#"><i class="fa fa-tachometer"></i> Quản Lý Liên Hệ</button>
        <div class="accordion_content">
    ...
    @if($currentUser->hasRole(config('global.mail_sub_contact_us')) || $currentUser->hasRole(config('global.admin')))
        <button class=" padding-left-5 accordion-button white-text text-left btn background-gradient-cyan-plum no-border-radius btn-block border-left-green-m box-shadown-light-dark mt-2" href="#"><i class="fa fa-tachometer"></i> Quản Lý Đăng Ký Nhận Mail</button>
        <div class="accordion_content">
